...
template<int NS, int NG, int D, typename T>
      ...
      if (numPatchMatchItersPerLevel[level] > 0)
      {
        ...
        else
        {
          patchmatchGPU(V2i(pyramid[level].targetWidth, pyramid[level].targetHeight),
            ...
            pyramid[level].Omega,
            patchSize,
            PatchSSD_Split<NS, NG, D, float>(pyramid[level].targetStyle,
              pyramid[level].sourceStyle,
              pyramid[level].targetGuide,
              pyramid[level].sourceGuide,
              styleWeightsVec,
...
)
{
  void(*const dispatchEbsynth[EBSYNTH_MAX_GUIDE_CHANNELS])(int, int, int, int, int, void*, void*, int, int, void*, void*, float*, float*, float, int, int, int, int*, int*, int*, void*) =
  {
    ...
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,3,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,4,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,5,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,6,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,7,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,8,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,9,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,10,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,11,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,12,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,13,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,14,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,15,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,16,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,17,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,18,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,19,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,20,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,21,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,22,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,23,EBSYNTH_PHI_DEGREE>,
    runEbsynth<EBSYNTH_NUM_STYLE_CHANNELS,24,EBSYNTH_PHI_DEGREE>,
  };
